...
`20260829090000_baseline` is the retained immutable representation of the physical
...
3. Mark only the baseline as already applied:
   ...
   ```sh
   npx prisma migrate resolve --applied 20260829090000_baseline
   ```

4. Let Railway's pre-deploy command apply the additive lead-intake,
   qualifier, auth, saved-content, assistant-usage, and cash-buyer migrations
   only after
